		...
		<div class="col-md-12" style="margin-top: 120px;">
			<div class="col-md-12"
				...
				<div class="col-md-10" style="display: flex; margin-top: 10px;">
					...
					<input class="form-control col-md-4" name="getsub" type="text">
					<button class="btn col-md-2"
						style="font-weight: 600; margin-left: 10px;" id="getsub">Get</button>
					<div style="margin-left: 5px; margin-top:15px;"><strong>OR</strong></div>
					<button class="btn col-md-2 fa fa-upload"
						style="font-weight: 600; margin-left: 10px;" id="upload"> Upload video</button>
				</div>
			</div>
		</div>

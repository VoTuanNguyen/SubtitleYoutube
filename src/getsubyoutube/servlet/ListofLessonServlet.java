		...
		try {
			...
			if (lst.size() > 0) {
				for (Lesson ls : lst) {
					...
					if(ls.getLinkimg().length() == 0){
						out.print("<img src=\"./images/no_image.jpg\" style=\"height: 400px; width: 300px\" class=\"thumbnail\">");
					}else{
						out.print("<img src=\""
								+ ls.getLinkimg()
					...
					if(ls.getNameSub().length() > 0){
						out.print("<div class=\"col-sm-6\"><a href=\"videolocal?namevideo="
								+ ls.getIdvideo()+"&namesub="+ls.getNameSub()
